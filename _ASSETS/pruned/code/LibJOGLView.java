/*  $Id: LibJOGLView.java 1237 2013-01-02 13:05:24Z jenetic.bytemare@googlemail.com $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class LibJOGLView extends LibGLView implements GLEventListener
    {
        ...
        public LibJOGLView( GLDrawCallback aDrawCallback, LibDebug aDebug, float aAspectRatio )
        {
        ...
        {
            gl.glLoadIdentity();                                                                        //create new identity

            gl.glNormal3f(    0.0f,                   0.0f,           0.0f                    );        //normalize

            gl.glRotatef(     viewSet.rot.y,          0.0f,           0.0f,           1.0f    );        //rotate z (!)
            gl.glRotatef(     viewSet.rot.x,          1.0f,           0.0f,           0.0f    );        //rotate x
            gl.glRotatef(     360.0f - viewSet.rot.z, 0.0f,           1.0f,           0.0f    );        //rotate y (!)

            gl.glTranslatef(  viewSet.pos.x,          viewSet.pos.z,  viewSet.pos.y           );        //translate x z y
        }
...
//                      gl.glColor4f(     0.5f, 0.5f, 0.5f, 0.25f                         );
        ...
        public final void initTextures( LibGLImage[] texImages )
        {
            ...
            gl.glGenTextures( iTextureImages.length, IntBuffer.allocate( iTextureImages.length ) );
        ...
        **************************************************************************************/
        ...
        {
            //clear the gl and set a new identity
            gl.glClearColor(    clearCol.f3[ 0 ], clearCol.f3[ 1 ], clearCol.f3[ 2 ], 0.0f      );
        ...
        public void setLightsOn( LibGLLight[] lights, LibColors ambient )
        {
            ...
            //init light 1
            for ( LibGLLight light : lights )
            {
                setLight( GL.GL_LIGHT0, light );
            }
...
*/
        ...
        public void setNewGluFaceAngle( float faceAngle )
        {
            ...
            glu.gluPerspective( faceAngle, iAspectRatio, LibGLView.VIEW_MIN, LibGLView.VIEW_MAX );
        }
    }

/*  $Id: Geometry.java 1134 2012-03-12 19:51:02Z jenetic.bytemare $
 *  =======================================================================================
 ...
 */
    ...
    **************************************************************************************/
    public final class Geometry
    {
         ...
         *                                                false otherwise.
         */
        private static boolean isPointInsideRectangle (int x0, int y0, int x1, int y1,
                                                                                                    int x, int y)
        {
        ...
        private static boolean isPointInsidePolygon ( double[] x, double[] y, double pointX, double pointY )
        {
         ...
         * @return    True if the given point is inside the polygon, false otherwise.
         */
        private static boolean isPointInsidePolygon (int[] x, int[] y,
         ...
         * @param intersectionP                             Coordinate of point we are looking for
         */
        private static double[] computePointOnLine (double[] p0, double[] p1,
         ...
         */
        private static double[] computePointOnLine (double x0, double y0,
                                                                                             double x1, double y1,
         ...
         *                                    direction and so on.
         */
        private static void extendLine (double[] p0, double[] p1, double toLength,
                                                                     double anchor)
        {
         ...
         */
        private static double length (double[] p0, double[] p1)
        {
         ...
         */
        private static double length (int x0, int y0, int x1, int y1)
        {
         ...
         */
        private static double length (int[] x, int[] y, boolean isClosed)
        {
            double length = 0.0;
         ...
         */
        private static double computeAngle (double[] p0, double[] p1, double[] p2)
        {
         ...
         */
        private static double computeDotProduct (double[] v0, double[] v1)
        {
         ...
         */
        private static double[] computeCrossProduct (double[] v0, double[] v1)
        {
         ...
         */
        private static boolean isLineIntersectingLine (int x0, int y0, int x1, int y1,
         ...
         *                                                false otherwise.
         */
        private static boolean isLineIntersectingRectangle (int lx0, int ly0,
                                                                                                             int lx1, int ly1,
                                                                                                             int x0, int y0,
                                                                                                             int x1, int y1)
        {
         ...
         *                                                false otherwise.
         */
        private static boolean isPolylineIntersectingRectangle (int[] x, int[] y,
                                                                                                                     int x0, int y0,
                                                                                                                     int x1, int y1)
        {
         ...
         */
        private static boolean isPolygonIntersectingRectangle (int[] x, int[] y,
                                                                                                                    int x0, int y0,
                                                                                                                    int x1, int y1)
        {
            int n = x.length;
         ...
         */
        private static double computePolygonArea (double[] x, double[] y)
        {
            int n = x.length;
         ...
         * @return        Area of specified polygon.
         */
        private static double computePolygonArea (double[] xy)
        {
            int n = xy.length;
         ...
         */
        private static double[] computePolygonCentroid (double[] x, double[] y)
        {
            double cx = 0.0;
            double cy = 0.0;
         ...
         */
        private static void findPolygonExtent (double[] x, double[] y, double[] z,
                                                                                    double[] xExtent,
                                                                                    double[] yExtent,
                                                                                    double[] zExtent)
        {
         ...
         */
        @SuppressWarnings( "unused" )
        private static void findPolygonExtent (int[] x, int[] y,
        ...
        public static Point2D.Float findLineSegmentIntersection( Line2D.Float line1, Line2D.Float line2 )
        {
            ...
            //though Geometry is external api..
            if ( res < 1 )
            {
                throw new IllegalArgumentException( "bug in external class Geometry! no intersection point found!" );
            }
         ...
         */
        @SuppressWarnings( "unused" )
        private static double[] findLinePolygonIntersections (double[] x, double[] y,
         double x0, double y0,
         double x1, double y1)
        {
            double                    x2, y2, x3, y3;
         ...
         */
        private static int[] createEllipse (int[] x, int[] y)
        {
            // Center of ellipse
            int x0 = (x[0] + x[2]) / 2;
            int y0 = (y[0] + y[2]) / 2;
            ...
            double[] p0 = { x0,   y0,   0.0 };
            double[] p1 = { x[0], y[0], 0.0 };
            double[] p2 = { x[1], y[1], 0.0 };
         ...
         */
        private static int[] createEllipse (int x0, int y0, int dx, int dy)
        {
         ...
         * @return        Ellipse geometry [x,y,x,y,...].
         */
        private static double[] createEllipse (double x0, double y0,
                                                                                    double dx, double dy)
        {
            // Make sure deltas are positive
            dx = Math.abs (dx);
         ...
         */
        private static int[] createCircle (int x0, int y0, int radius)
        {
         ...
         * @return                Geometry of circle [x,y,...]
         */
        private static double[] createCircle (double x0, double y0, double radius)
        {
            return createEllipse (x0, y0, radius, radius);
        }
         ...
         */
        private static int[] createSector (int x0, int y0, int dx, int dy,
         ...
         * @return                Geometry of secor [x,y,...]
         */
        private static int[] createSector (int x0, int y0, int radius,
                                                                            double angle0, double angle1)
        {
         ...
         */
        private static int[] createArrow (int[] x, int[] y,
         ...
         */
        private static int[] createArrow (int x0, int y0, int x1, int y1,
                                                                         double length, double angle, double inset)
        {
            int[] x = {x0, x1};
            int[] y = {y0, y1};
         ...
         */
        private static int[] createRectangle (int x0, int y0, int width, int height)
        {
         ...
         * @param height    Height (may be negative to indicaten upwards direction)
         */
        private static double[] createRectangle (double x0, double y0,
         ...
         */
        private static int[] createStar (int x0, int y0,
         ...
         * @return                         Geometry of star [x,y,x,y,...].
         */
        private static double[] createStar (double x0, double y0,
         ...
         */
        private static boolean findPolygonPosition (int[] x, int[] y,
                                                                                             double length,
                                                                                             int[] position)
        {

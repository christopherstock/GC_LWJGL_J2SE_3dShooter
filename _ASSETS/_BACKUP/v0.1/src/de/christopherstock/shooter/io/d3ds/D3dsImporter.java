 ...
 */
    ...
    /********************************************************************************
    *   Currently updated to reg-ex-functionality-3d studio max ascii scene export file importer.
    ...
    ********************************************************************************/
    public class D3dsImporter
    {
        ...
        **************************************************************************************/
        ...
        {
            Debug.d3ds.out( "=======================================" );
            Debug.d3ds.out( "Parsing 3dsmax-file [" + this + "]" );
            ...
            {
                Debug.err( "i/o error on loading d3ds resource [" + file.ordinal() + "]" );
                e.printStackTrace();
                return;
            }
        }
        ...
        **************************************************************************************/
        ...
        private static final String readAse( int index )
        {
            ...
            {
                Debug.err( "ERROR loading 3ds max file [" + index + "]" );
                return null;
            }
        }
                ...
                for( MaxFace face : faces3ds )
                {
                    ...
                    try
                    {
                        ...
                        (
                            ...
                            material.color,
                            new Vertex ( face.vertex1.y, face.vertex1.x, face.vertex1.z, ( face.vertex1.u + material.offsetU ) * material.tilingU, ( face.vertex1.v + material.offsetV ) * material.tilingV ),
                            new Vertex ( face.vertex2.y, face.vertex2.x, face.vertex2.z, ( face.vertex2.u + material.offsetU ) * material.tilingU, ( face.vertex2.v + material.offsetV ) * material.tilingV ),
                            new Vertex ( face.vertex3.y, face.vertex3.x, face.vertex3.z, ( face.vertex3.u + material.offsetU ) * material.tilingU, ( face.vertex3.v + material.offsetV ) * material.tilingV )
                        );
                        allFaces.add( ft );
                    }
                    catch ( Exception ioe )
                    {
                        Debug.err( "I/O Exception on writing parsed ASE-File!" );
                        ioe.printStackTrace();
                    }
                }
            }

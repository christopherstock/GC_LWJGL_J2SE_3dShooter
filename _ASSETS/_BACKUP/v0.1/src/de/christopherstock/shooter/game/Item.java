 ...
 */
    ...
    **************************************************************************************/
    class Item
    {
        ...
        private Item( ItemType type, float x, float y, float z, float radius )
        {
            this.type   = type;
            this.anchor = new Vertex( x, y, z, 0.0f, 0.0f );
            this.radius = radius;
        }
            ...
            switch ( type )
            {
                case ETypeCircle:
                {
                    if ( Shooter.DEBUG_DRAW_ITEM_CIRCLE )
                    {
                        ...
                        GLView.drawFace( new FaceEllipseFloor( null, DEBUG_COLOR, anchor.x, anchor.y, anchor.z, radius, radius ) );
                    }
                    break;
                }
            }
        ...
        private final void checkCollision()
        {
            ...
            */
            ...
            Area player = new Area( Player.user.cylinder.getCircle() );

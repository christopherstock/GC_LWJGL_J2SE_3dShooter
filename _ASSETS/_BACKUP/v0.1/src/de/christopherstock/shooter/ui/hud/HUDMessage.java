 ...
 */
    ...
    **************************************************************************************/
    public final class HUDMessage
    {
        ...
        public HUDMessage( String text )
        {
            this.text       = text;
            this.animState  = ANIM_STATE_POP_UP;
            this.anim       = TICKS_POP_UP - 1;
        }
        ...
        public final void draw( Graphics2D g, int index )
        {
            ...
            if ( anim > -1 )
            {
                ...
                //draw text
                int x = GLPanel.PANEL_WIDTH  - Offset.EBorderHudX ;
                int y = GLPanel.PANEL_HEIGHT - Offset.EBorderHudY - Offset.EHudMsgY - index * 15;

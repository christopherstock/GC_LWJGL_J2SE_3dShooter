 ...
 */
    ...
    **************************************************************************************/
    public final class AvatarMessage
    {
        ...
        {
            textLines = Strings.breakLinesOptimized( (Graphics2D)GLPanel.glPanel.getNativePanel().getGraphics(), aText, Fonts.EAvatarMessage, GLPanel.glPanel.width - Offset.EAvatarImageX - avatarImages[ 0 ].width - Offset.EAvatarTextX - Offset.EBorderHudX );
        }
        ...
        public static final void drawMessage( Graphics2D g )
        {
            ...
            if ( anim > -1 && messageQueue.size() > 0 )
            {
                ...
                g.fillRect( 0, 0, GLPanel.glPanel.width, Offset.EAvatarBgPanelHeight );

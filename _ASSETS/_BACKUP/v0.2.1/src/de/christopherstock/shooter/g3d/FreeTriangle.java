...
import  de.christopherstock.shooter.ui.*;
    ...
    **************************************************************************************/
    public class FreeTriangle extends Face
    {
        ...
        public FreeTriangle( LibVertex ank, GLTexture texture, Colors col, LibVertex a, LibVertex b, LibVertex c )
        {
        ...
        ***********************************************************************************/
        public HitPoint launchShot( Shot shot )
        {
            ...
            Debug.shot.out( "==============\nHORZ FACE HIT!" );
            Point2D.Float intersectionPointHorz = LibMathGeometry.findLineSegmentIntersection( shot.lineShotHorz, collisionLineHorz, Debug.bugfix.debug );
            ...
            Point2D.Float   intersectionPointVert   = LibMathGeometry.findLineSegmentIntersection( shot.lineShotVert, collisionLineVert, Debug.bugfix.debug );
            ...
            (
                parentGameObject,
                shot,
                ( texture == null ? GLMaterial.EUndefined.getBulletHoleTexture() : texture.getMaterial().getBulletHoleTexture() ),
        ...
        {
            LibVertex ankCopy = new LibVertex( anchor.x, anchor.y, anchor.z, anchor.u, anchor.v );
            LibVertex aCopy   = new LibVertex( originalVertices[ 0 ].x, originalVertices[ 0 ].y, originalVertices[ 0 ].z, originalVertices[ 0 ].u, originalVertices[ 0 ].v );
            LibVertex bCopy   = new LibVertex( originalVertices[ 1 ].x, originalVertices[ 1 ].y, originalVertices[ 1 ].z, originalVertices[ 1 ].u, originalVertices[ 1 ].v );
            LibVertex cCopy   = new LibVertex( originalVertices[ 2 ].x, originalVertices[ 2 ].y, originalVertices[ 2 ].z, originalVertices[ 2 ].u, originalVertices[ 2 ].v );

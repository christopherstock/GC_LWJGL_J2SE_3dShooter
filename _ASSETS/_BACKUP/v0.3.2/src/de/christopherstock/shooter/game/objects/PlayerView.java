/*  $Id: View.java 431 2011-03-19 17:48:24Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    public class PlayerView implements PlayerAttributes
    {
        ...
        **************************************************************************************/
        ...
        protected final void handleKeysForView()
        {
            ...
            {
                ShooterDebug.mouse.out( "HANDLE: mouse movement X ["+Mouse.mouseMovementX+"]" );

                rot.z -= Mouse.mouseMovementX * 2 * SPEED_TURNING_Z;
                rot.z = rot.z < 0.0f ? rot.z + 360.0f : rot.z;
                rot.z = rot.z >= 360.0f ? rot.z - 360.0f : rot.z;

/*  $Id: Shot.java 542 2011-04-13 14:47:36Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class Shot
    {
        ...
        public Shot( ShotType aType, ShotOrigin aOrigin, float irregularityAngle, float irregularityDepth, float startX, float startY, float startZ, float aRotZ, float aRotX, float aShotRange, LibHoleSize aBulletHoleSize, LibDebug aDebug )
        {
            iType           = aType;
            iOrigin         = aOrigin;
            ...
            iRotZ           += irregularityAngle;
            iRotX           += irregularityDepth;
        ...
        public HitPoint launch()
        {
            ...
            for ( WallCollection wallCollection : Level.current().getWallCollections() )
            {
            ...
            {
                for ( Bot bot : Level.current().getBots() )
                {
            ...
            {
                hitPoints.addAll( Level.currentPlayer().launchShot( this ) );
            }
            ...
            )
            {
                ...
                switch ( nearestHitPoint.carrier.getHitPointCarrier() )
                {
                    ...
                    {
                        //player loses health
                        Level.currentPlayer().hurt( LibMath.getRandom( 2, 10 ) );
                        break;
                    }

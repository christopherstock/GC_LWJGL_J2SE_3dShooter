/*  $Id: LibMathGeometry.java 202 2011-01-09 17:41:33Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    public final class LibMathGeometry
    {
        ...
        **************************************************************************************/
        ...
        )
        {
            ...
            double a0 = LibMathGeometry.equals (x0, x1, LIMIT) ?
                                    INFINITY : (y0 - y1) / (x0 - x1);
            double a1 = LibMathGeometry.equals (x2, x3, LIMIT) ?
            ...
            if ( LibMathGeometry.equals ( a0, a1 ) )
            {
                if (!LibMathGeometry.equals (b0, b1))
                    return -1; // Parallell non-overlapping

                if (LibMathGeometry.equals (x0, x1)) {
                    if (Math.min (y0, y1) < Math.max (y2, y3) ||
                            Math.max (y0, y1) > Math.min (y2, y3)) {
                        double twoMiddle = y0 + y1 + y2 + y3 -
                                                             LibMathGeometry.min (y0, y1, y2, y3) -
                                                             LibMathGeometry.max (y0, y1, y2, y3);
                        y = (twoMiddle) / 2.0;
                        x = (y - b0) / a0;
                    }
                    ...
                    if (Math.min (x0, x1) < Math.max (x2, x3) ||
                        ...
                        double twoMiddle = x0 + x1 + x2 + x3 -
                                                             LibMathGeometry.min (x0, x1, x2, x3) -
                                                             LibMathGeometry.max (x0, x1, x2, x3);
                        x = (twoMiddle) / 2.0;
                        y = a0 * x + b0;
                    }
                    else return -1;
            ...
            if (LibMathGeometry.equals (a0, INFINITY)) {
                x = x0;
                y = a1 * x + b1;
            }
            else if (LibMathGeometry.equals (a1, INFINITY)) {
                x = x2;
                y = a0 * x + b0;
            }
            else {
            ...
            if ( LibMathGeometry.equals ( x2, x3 ) )
            {
                if (y2 < y3)
            ...
            return
            (
                    LibMathGeometry.equals (distanceFrom1, 0.0) && LibMathGeometry.equals (distanceFrom2, 0.0)
                ?   1
                :   0
            );
        }

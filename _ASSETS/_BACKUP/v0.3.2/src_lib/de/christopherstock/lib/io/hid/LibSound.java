 ...
 */
    ...
    *   @version    0.3.2
    **************************************************************************************/
    public class LibSound extends Thread
    {
        ...
        public LibSound( LibDebug aDebug, LibSoundFactory aFactory )
        {
            this( aDebug, aFactory, VOLUME_MAX, BALANCE_BOTH );
        }

        public LibSound( LibDebug aDebug, LibSoundFactory aFactory, float aVolume, float aBalance )
        {
            iDebug   = aDebug;
            iFactory = aFactory;
...
*/
                //start clip from the beginning ( may be obsolete )

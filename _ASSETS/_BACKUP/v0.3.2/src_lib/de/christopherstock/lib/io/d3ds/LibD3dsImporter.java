/*  $Id: D3dsImporter.java 245 2011-02-02 00:04:41Z jenetic.bytemare $
 *  =================================================================================
 */
    ...
    ********************************************************************************/
    public class LibD3dsImporter
    {
        ...
        *************************************************************************************/
        ...
        /*************************************************************************************
        *   Warning on import if the ase file specifies more than this number of faces.
        *   No more low poly model.
        *************************************************************************************/
        public      static  final   int                 MAX_FACES                   = 500;
        ...
        private final String readAse()
        {
            try
            {
                InputStream     is          = LibD3dsImporter.class.getResourceAsStream( iFilename );

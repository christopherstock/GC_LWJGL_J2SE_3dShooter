/*  $Id: JOGLView.java 208 2011-01-21 17:04:29Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class LibJOGLView extends LibGLView implements GLEventListener
    {
        ...
        public LibJOGLView( GLCallbackInit aCallbackGLinit, GLCallback2D aCallback2D, GLCallback3D aCallback3D, LibGLImage[] aTextureImages, LibDebug aDebug, int aFormWidth, int aFormHeight, boolean aEnableLights )
        {
            super( aCallbackGLinit, aDebug, aFormWidth, aFormHeight, aEnableLights );
        ...
        public void init( GLAutoDrawable glDrawable )
        {
            ...
            //set perspective
            glu.gluPerspective( VIEW_ANGLE, ( (float)iFormWidth / (float)iFormHeight ), VIEW_MIN, VIEW_MAX );
        ...
        @Override
        public final void drawDebugPoint( LibGLView.DebugPoint3D fxPoint )
        {
...
//                      gl.glColor4f(     0.5f, 0.5f, 0.5f, 0.25f                         );
        ...
        **************************************************************************************/
        ...
        @Override
        public void drawOrthoBitmapBytes( LibGLImage glImage, int x, int y, int alpha )
        {
            ...
            else
            {
                ...
                gl.glBlendColor( 1.0f, 1.0f, 1.0f, alphaF );
        ...
        public void setOrthoOn()
        {
            ...
            gl.glOrtho( 0, iFormWidth, 0, iFormHeight, -1, 1 ); // turn on 2D
            gl.glMatrixMode( GL.GL_MODELVIEW );

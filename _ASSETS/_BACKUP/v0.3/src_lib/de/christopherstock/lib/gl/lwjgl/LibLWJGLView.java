        ...
        public LibLWJGLView( GLCallbackInit aCallbackGLinit, LibGLPanel panel, LibGLImage[] aTextureImages, LibDebug aDebug, int aFormWidth, int aFormHeight, boolean aEnableLights )
        {
            ...
            try
            {
                ...
                for ( DisplayMode dm : dms )
                {
                    ...
                    if
                    (
                            iFormWidth  == dm.getWidth()
                        &&  iFormHeight == dm.getHeight()
        ...
        **************************************************************************************/
        ...
        public void drawOrthoBitmapBytes( LibGLImage glImage, int x, int y, int alpha )
        {
            ...
            else
            {
                ...
                //blend opaque images translucent [ why can we mix GL 1.4 and GL 1.1 here and it works ?? ]
        ...
        public void setOrthoOn()
        {
            ...
            GL11.glOrtho( 0, iFormWidth, 0, iFormHeight, -1, 1 );   // turn on 2D
            GL11.glMatrixMode( GL11.GL_MODELVIEW );

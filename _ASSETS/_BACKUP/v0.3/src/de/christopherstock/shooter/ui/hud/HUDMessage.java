/*  $Id: HUDMessage.java 267 2011-02-10 20:29:29Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public final class HUDMessage
    {
        ...
        public final void show()
        {
            ...
            iTextImg       = LibGLImage.getFromString( iText, Fonts.EAvatarMessage, ShooterSettings.Colors.EHudMsgFg.colARGB, null, ShooterSettings.Colors.EHudMsgOutline.colARGB, ShooterDebugSystem.glimage, new Color( 0xffc0c0c0 ) );
        ...
        public static final void drawAllMessages()
        {
            ...
            {
                int drawY = Offset.EBorderHudY + ( Level.currentPlayer().showAmmoInHUD() ? 2 * messageQueue.elementAt( 0 ).iTextImg.height : 0 );
        ...
        private final void draw( int drawY )
        {
            ...
            if ( iAnim > -1 )
            {
                ...
                //draw text
                int x = LibGL3D.panel.width  - Offset.EBorderHudX - iTextImg.width;

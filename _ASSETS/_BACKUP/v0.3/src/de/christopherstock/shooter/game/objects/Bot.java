/*  $Id: Bot.java 261 2011-02-10 00:39:04Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class Bot implements GameObject
    {
        ...
        **************************************************************************************/
        ...
        {
            for ( Bot bot : Level.current().bots )
            {
                //skip own !
                ...
                {
                    ShooterDebugSystem.bot.out( "own bot touched" );
                    return true;
                        ...
                        case EStateWalkWayPoints:
                        {
                            ...
                            if ( wayPoints != null )
                            {
                                ...
                                if ( turningDistance >= SPEED_TURNING_MIN )
                                {
                                    ...
                                    ShooterDebugSystem.bot.out( "turning bot, src ["+facingAngle+"] target ["+angleBotToWayPoint+"] distance is [" + angleDistance + "]" );

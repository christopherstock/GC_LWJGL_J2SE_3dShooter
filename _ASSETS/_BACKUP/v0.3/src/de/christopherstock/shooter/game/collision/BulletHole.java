/*  $Id: BulletHole.java 248 2011-02-02 01:21:57Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class BulletHole
    {
        ...
        public BulletHole( HitPoint hitPoint )
        {
            ...
            ShooterDebugSystem.bullethole.out( "new bullet hole: face-angle [" + hitPoint.horzFaceAngle + "]" );
            ...
            ShooterDebugSystem.bullethole.out( "bullet-points: ["+point1.x+"]["+point1.y+"] ["+point2.x+"]["+point2.y+"]" );
        ...
        private final void rotateAroundVertex( LibVertex vertex, float rotZ )
        {
            ...
            ShooterDebugSystem.bullethole.out( "turn for [" + rotZ + "]" );
            ...
            horzFaceAngle += rotZ;
            ShooterDebugSystem.bullethole.out( "setting bullet hole angle to [" + horzFaceAngle + "]" );

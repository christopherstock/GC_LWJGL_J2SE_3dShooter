/*  $Id: Shot.java 224 2011-01-25 18:05:42Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class Shot
    {
        ...
        public Shot( ShotOrigin aOrigin, boolean aViewOnly, float irregularityAngle, float irregularityDepth, float startX, float startY, float startZ, float aRotZ, float aRotX, float aShotRange, BulletHole.PointSize aBulletHoleSize )
        {
            ...
            ShooterDebugSystem.shot.out( "SHOT LINE HORZ [" + srcPoint.x + "," + srcPoint.y + "] to [" + endPointHorz.x + "," + endPointHorz.y + "]" );
            ...
            ShooterDebugSystem.shot.out( "SHOT LINE VERT " + srcPointVert + endPointVert );
        ...
        public HitPoint launch()
        {
            ...
            hitPoint = Level.current().launchShot( this );
        ...
        public final void drawShotLine()
        {
            ...
            for ( float distance = 0.0f; distance < Level.currentPlayer().getWearpon().getShotRange(); distance += 0.01f )
            {
                LibGLDebugPoint.add
                (
                    LibColors.EYellow,

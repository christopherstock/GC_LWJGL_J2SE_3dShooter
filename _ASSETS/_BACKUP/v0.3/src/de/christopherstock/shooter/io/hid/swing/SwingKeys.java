/*  $Id: SwingKeys.java 255 2011-02-09 18:53:37Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class SwingKeys extends Keys implements KeyListener
    {
        ...
        {
            ShooterDebugSystem.keys.out( "key pressed " + e.getKeyCode() );
        ...
        public static void onKeyDown( int keyCode )
        {
            switch ( keyCode )
            {
                ...
                case KeyEvent.VK_K:
                {
                    ShooterMainThread.letPlayerDie = true;
                    break;
                }
                ...
                {
                    //launch msg
                    ShooterMainThread.launchAvatarMessage = true;
                ...
                case KeyEvent.VK_X:
                {
                    //test explosion
                    //Debug.DEBUG_OUT( "launch explosion!" );
                    ShooterMainThread.launchExplosion = true;

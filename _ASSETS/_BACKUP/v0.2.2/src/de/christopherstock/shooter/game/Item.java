/*  $Id: Item.java 191 2010-12-13 20:24:11Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class Item
    {
        ...
        {
            type   = aType;
            anchor = new LibVertex( x, y, z, 0.0f, 0.0f );
            radius = aRadius;
        }
        ...
        public static final void checkCollisions()
        {
        ...
        private final void draw()
        {
            switch ( type )
            {
                case ETypeCircle:
                {
                    if ( ShooterSettings.DEBUG_DRAW_ITEM_CIRCLE )
                    {
                        //Debug.item.out( "drawing item .." );
                        new FaceEllipseFloor( null, DEBUG_COLOR, anchor.x, anchor.y, anchor.z, radius, radius ).draw();
                    }
                    break;
                }
            }
        ...
        private final void checkCollision()
        {
            ...
            */
            ...
            Area player = new Area( Level.currentPlayer().cylinder.getCircle() );
            ...
            if ( !player.isEmpty() )
            {
                ...
                Debug.bugfix.info( "item collected" );
                collected = true;
            }
            else
            {

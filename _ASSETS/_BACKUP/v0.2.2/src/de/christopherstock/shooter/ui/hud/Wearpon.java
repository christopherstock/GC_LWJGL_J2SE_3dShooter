/*  $Id: Wearpon.java 191 2010-12-13 20:24:11Z jenetic.bytemare $
 *  =======================================================================================
 */
...
//      EAutomaticShotgun(  AmmoType.shotgunShells,         15.0f,      50,         50,         2,              10,     3,              5,                  false       ),
        ...
        public      static          GLImage[]           wearponImages               = null;
        ...
        public static final void loadImages()
        {
            ...
            wearponImages = GLImage.loadAllEnumNames( new Vector<Object>( Arrays.asList( values() ) ),  Path.EWearpons.url, ".png", ImageUsage.EOrtho );
        }
...
*/
        ...
        {
            int centerX = GLPanel.singleton.width  / 2;
            int centerY = GLPanel.singleton.height / 2;
        ...
        public final void reload()
        {
            ...
            Level.currentPlayer().ammo.addAmmo( iAmmoType, iMagazineAmmo );

            //check ammo stock
            int ammo = Level.currentPlayer().ammo.getAmmo( iAmmoType );
            ...
            Level.currentPlayer().ammo.substractAmmo( iAmmoType, ammoToReload );

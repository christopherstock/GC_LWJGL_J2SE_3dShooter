/*  $Id: HUDMessage.java 191 2010-12-13 20:24:11Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    public final class HUDMessage
    {
        ...
        public final void draw( Graphics2D g, int index )
        {
            ...
            if ( anim > -1 )
            {
                ...
                //draw text
                int x = GLPanel.singleton.width  - Offset.EBorderHudX ;
                int y = GLPanel.singleton.height - Offset.EBorderHudY - Offset.EHudMsgY - index * 15;
                Color originalTextCol   = new Color( ShooterSettings.Colors.EHudMsgFg.rgb     );
                Color originalShadowCol = new Color( ShooterSettings.Colors.EHudMsgOutline.rgb );
                ...
                LibStrings.drawString( g, textCol, null, outlineCol, Fonts.EAvatarMessage, LibAnchor.EAnchorRightBottom, text, x, y );
            }
        }
    }

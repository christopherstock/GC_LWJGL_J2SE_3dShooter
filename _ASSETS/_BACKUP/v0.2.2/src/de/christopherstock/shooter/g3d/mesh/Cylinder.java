/*  $Id: Cylinder.java 192 2010-12-13 22:25:43Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class Cylinder extends GeomObject
    {
        ...
        */
        private final HitPoint launchAShot( Shot shot )
        {
            ...
            if ( horizontalIntersection )
            {
                ...
                Texture bht = GLMaterial.EUndefined.getBulletHoleTexture();
        ...
        ************************************************************************************/
        ...
        {
            target = new LibVertex( tX, tY, tZ );
        }

        public void drawStandingCircle()
        {
            if ( ShooterSettings.DEBUG_SHOW_PLAYER_CIRCLE )
            {
        ...
        {
            //set a debug point!
            DebugPoint.add( LibColors.EGreen, anchor.x, anchor.y, anchor.z + height / 2, DebugPoint.ELifetimeLong );
        }
        ...
        **************************************************************************************/
        ...
        public final void moveToNewPosition( float newHeight )
        {
            ...
            for ( float j = ShooterSettings.COLLISION_CHECKING_STEPS; j > 0; --j )
            {
                //try next step point..
                float distanceToCheckX = distX * j / ShooterSettings.COLLISION_CHECKING_STEPS;
                float distanceToCheckY = distY * j / ShooterSettings.COLLISION_CHECKING_STEPS;
                float distanceToCheckZ = distZ * j / ShooterSettings.COLLISION_CHECKING_STEPS;

/*  $Id: Meshes.java 182 2010-11-13 13:33:42Z jenetic.bytemare $
 *  =======================================================================================
 */
...
/*
        ...
        enemy1,
        executiveOffice1,
        executiveOffice1Door1,
        executiveOffice1Door2,
        woman1,

 */
        ;
        //public static final void getMesh()
        {

/*
            woman1 = new Mesh
            (
                D3dsImporter.getFaces( D3dsFiles.EMeshWoman1 ),
                new Vertex( 20.0f, 20.05f, 0.01f )
            );
*/

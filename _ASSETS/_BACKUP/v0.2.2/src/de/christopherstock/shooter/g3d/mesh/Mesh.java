/*  $Id: Mesh.java 189 2010-12-13 20:02:19Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class Mesh extends GeomObject
    {
        ...
        **************************************************************************************/
        public Mesh( FreeTriangle[] aFaces, LibVertex aAnchor, float aInitRotZ, float aInitScale, GameObject aParentGameObject )
        {
            this( aFaces );

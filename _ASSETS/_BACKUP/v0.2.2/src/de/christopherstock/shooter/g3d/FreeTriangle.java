/*  $Id: FreeTriangle.java 192 2010-12-13 22:25:43Z jenetic.bytemare $
 *  =======================================================================================
 */
...
import  de.christopherstock.shooter.gl.*;
    ...
    **************************************************************************************/
    public class FreeTriangle extends Face
    {
        ...
        public FreeTriangle( LibVertex ank, Texture texture, LibColors col, LibVertex a, LibVertex b, LibVertex c, LibVertex aFaceNormal )
        {
        ...
        protected final void setCollisionValues()
        {
            ...
            Debug.freetriangle.out( "a: ["+iTransformedVertices[ 0 ].x+"]["+iTransformedVertices[ 0 ].y+"]["+iTransformedVertices[ 0 ].z+"]" );
            Debug.freetriangle.out( "b: ["+iTransformedVertices[ 1 ].x+"]["+iTransformedVertices[ 1 ].y+"]["+iTransformedVertices[ 1 ].z+"]" );
            Debug.freetriangle.out( "c: ["+iTransformedVertices[ 2 ].x+"]["+iTransformedVertices[ 2 ].y+"]["+iTransformedVertices[ 2 ].z+"]" );
        ...
        ***********************************************************************************/
        public HitPoint launchShot( Shot shot )
        {
            ...
            Debug.shot.out( "==============\nHORZ FACE HIT!" );
            Point2D.Float intersectionPointHorz = LibMathGeometry.findLineSegmentIntersection( shot.lineShotHorz, collisionLineHorz, Debug.bugfix );
            ...
            Point2D.Float   intersectionPointVert   = LibMathGeometry.findLineSegmentIntersection( shot.lineShotVert, collisionLineVert, Debug.bugfix );
            ...
            (
                parentGameObject,
                shot,
                ( iTexture == null ? GLMaterial.EUndefined.getBulletHoleTexture() : iTexture.getMaterial().getBulletHoleTexture() ),

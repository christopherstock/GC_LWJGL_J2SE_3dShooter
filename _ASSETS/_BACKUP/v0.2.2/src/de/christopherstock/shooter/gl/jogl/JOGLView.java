/*  $Id: JOGLView.java 192 2010-12-13 22:25:43Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class JOGLView extends GLView implements GLEventListener
    {
        ...
        public void init( GLAutoDrawable glDrawable )
        {
            ...
            GLPanel.singleton.width  = GLPanel.singleton.getNativePanel().getSize().width;
            GLPanel.singleton.height = GLPanel.singleton.getNativePanel().getSize().height;

...
import de.christopherstock.shooter.g3d.*;
    ...
    **************************************************************************************/
    public abstract class FX
    {
        ...
        {
            FX fx1 = new FXExplosion( new Vertex( 0.0f, 0.0f, 0.0f ), FXSize.ESmall,  FXTime.EShort  );
            FX fx2 = new FXExplosion( new Vertex( 2.0f, 2.0f, 0.0f ), FXSize.EMedium, FXTime.EMedium );
            FX fx3 = new FXExplosion( new Vertex( 4.0f, 4.0f, 0.0f ), FXSize.ELarge,  FXTime.ELong   );

...
import de.christopherstock.shooter.io.d3ds.D3dsImporter.*;
    ...
    **************************************************************************************/
    public class Wall extends GameObject
    {
        ...
        public Wall( D3dsFiles aMesh, Vertex aAnchor, CollisionEnabled aCollisionEnabled, WallAction aWallAction )
        {
            super( GameObject.HitPointCarrier.EWall );
            meshes              = new MeshCollection( aAnchor, new Mesh[] { new Mesh( D3dsImporter.getFaces( aMesh ), aAnchor, this ), } );
        ...
        public final void animate()
        {
            ...
            switch ( wallAction )
            {
                ...
                case EDoorTurning:
                {
                    ...
                    Vertex anchor = meshes.getAnchor();
                    if ( doorOpening )
                    {
                        //open the door
        ...
        **************************************************************************************/
        ...
        public final Vector<Float> launchFloorCheck( Point2D.Float point )
        {
            ...
            if ( collisionEnabled.flag )
            {
                vecZ.addAll( meshes.checkCollision( point ) );
            }

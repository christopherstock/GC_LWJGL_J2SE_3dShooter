    ...
    **************************************************************************************/
    public class Bot extends GameObject
    {
        ...
        **************************************************************************************/
        ...
        public Bot( BotType aType, Vertex aStartPosition, Point2D.Float[] aWayPoints, BotState aState )
        {
        ...
        protected final void drawDebugCircles()
        {
            if ( Shooter.DEBUG_DRAW_BOT_CIRCLES )
            {
                ...
                {
                    GLView.singleton.drawFace( new FaceEllipseFloor( null, col, ank.x, ank.y, ank.z + ( i * cylinder.getHeight() / VERTICAL_SLICES ), cylinder.getRadius(), cylinder.getRadius() ) );
                }
            }
        }
                    ...
                    switch ( state )
                    {
                        ...
                        case EStateWalkWayPoints:
                        {
                            ...
                            if ( wayPoints != null )
                            {
                                ...
                                float angleBotToWayPoint = UMath.normalizeAngle( angleWaypointToBot - 180.0f );
                                //Debug.bot.out( "angle player to bot is: " + anglePlayerToBot );
                                //Debug.bot.out( "angle bot to player is: " + angleBotToPlayer );
                                ...
                                float angleDistance   = UMath.getAngleDistance( facingAngle, angleBotToWayPoint );
                                ...
                                if ( turningDistance >= SPEED_TURNING_MIN )
                                {
                                    ...
                                    if ( angleDistance < 0 )
                                    {
                                        facingAngle = UMath.normalizeAngle( facingAngle - turningDistance );
                                    }

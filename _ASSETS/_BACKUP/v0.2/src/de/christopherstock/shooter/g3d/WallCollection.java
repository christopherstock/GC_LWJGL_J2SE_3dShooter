...
import de.christopherstock.shooter.g3d.mesh.*;
    ...
    import  de.christopherstock.shooter.io.d3ds.D3dsImporter.*;
            ...
            LEVEL_MESH_COLLECTION_DATA = new WallCollection[][]
            {
                ...
                new WallCollection[]
                {
                    ...
                    (
                        ...
                        {
                            //the level
                            new Wall( D3dsFiles.EMeshLevelDesert1,          new Vertex( 0.0f,   0.0f,   0.0f    ), CollisionEnabled.YES, WallAction.ENone           ),

                            //a room
                            new Wall( D3dsFiles.EMeshExecutiveOffice1,      new Vertex( 14.0f,  8.0f,   0.01f   ), CollisionEnabled.YES, WallAction.ENone           ),

                            //door for the room
                            new Wall( D3dsFiles.EMeshExecutiveOffice1Door1, new Vertex( 7.95f,  9.225f, 0.01f   ), CollisionEnabled.YES, WallAction.EDoorSliding    ),

                            //spawn 2nd door
                            new Wall( D3dsFiles.EMeshExecutiveOffice1Door1, new Vertex( 5.95f,  5.225f, 0.01f   ), CollisionEnabled.YES, WallAction.EDoorTurning    ),

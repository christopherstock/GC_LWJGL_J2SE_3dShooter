...
import de.christopherstock.shooter.math.*;
    ...
    **************************************************************************************/
    public class Cylinder extends GeomObject
    {
        ...
        public Cylinder( GameObject aParentGameObject, Vertex aAnchor, float aRadius, float aHeight )
        {
            anchor              = aAnchor;
        ...
        public final void drawDebug()
        {
            if ( Shooter.DEBUG_DRAW_BOT_CIRCLES )
            {
                ...
                {
                    GLView.singleton.drawFace( new FaceEllipseFloor( null, color, anchor.x, anchor.y, anchor.z + ( i * height / DEBUG_SLICES ), radius, radius ) );
                }
            }
        }
        ...
        */
        private final HitPoint launchAShot( Shot shot )
        {
            ...
            if ( horizontalIntersection )
            {
                ...
                Texture bht = Material.EUndefined.getBulletHoleTexture();
                ...
                (
                    ...
                    shot,
                    bht,
                    new Vertex( intersectionPoint.x, intersectionPoint.y, z ),
        ...
        ************************************************************************************/
        ...
        {
            if ( Shooter.DEBUG_SHOW_PLAYER_CIRCLE ) GLView.singleton.drawFace( new FaceEllipseFloor( null, Colors.ERed, anchor.x, anchor.y, anchor.z + 0.001f, radius, radius ) );
        }
        ...
        **************************************************************************************/
        ...
        public final void moveToNewPosition( float newHeight )
        {
            ...
            for ( float j = Shooter.COLLISION_CHECKING_STEPS; j > 0; --j )
            {
                ...
                if ( Level.checkCollision( this ) == false )
                {

 ...
 *  =======================================================================================
 */
    package de.christopherstock.shooter.math;
    ...
    **************************************************************************************/
    public abstract class Matrix
    {
        ...
        public static final Vertex[] transformVertices( Vertex[] va, Vertex ank, float angleX, float angleY, float angleZ )
        {
            ...
            return ret.toArray( new Vertex[] {} );
        }

        public static final Vertex transformVertex( Vertex v, Vertex ank, float angleX, float angleY, float angleZ )
        {
            //get ( and multiply ) rotation-matrices for X Y and Z axis
            float[][] trans =                  getRotXMatrix( angleX );
                      trans = Matrix.multiply( getRotYMatrix( angleY ), trans );
                      trans = Matrix.multiply( getRotZMatrix( angleZ ), trans );

            //translate by anchor
            Vertex vReset = new Vertex( v.x - ank.x, v.y - ank.y, v.z - ank.z, v.u, v.v );
            ...
            Vertex vFinal = new Vertex( vReset.x + ank.x, vReset.y + ank.y, vReset.z + ank.z, vReset.u, vReset.v );
        ...
        {
            float sin = UMath.sinDeg( angle );
            float cos = UMath.cosDeg( angle );
            return new float[][]
            {
                new float[] {   1,    0,     0,      0   },

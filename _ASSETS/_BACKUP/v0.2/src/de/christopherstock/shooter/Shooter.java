...
import  de.christopherstock.shooter.ui.hud.*;
    ...
    *   TODO NORMAL  stick bullet-holes to meshes!
    *   TODO NORMAL  low startup performance?
    *   TODO NORMAL  different bullet-holes for different materials ( stick to texture )
    *
    ...
    public class Shooter
    {
        ...
        **************************************************************************************/
        public static final void main( String[] args )
        {
            ...
            (
                MainThread.singleton,
                Texture.loadTextureImages()
            );
            GLPanel.glPanel = new GLPanel                       //init gl panel
            (
                GLView.singleton,
                HUD.singleton,
                Keys.singleton,
          ...
          //Sound.playSoundBg( Sound.ESoundBackground1 );       //test sound-engine
            Player.singleton.getWearpon().cheatAmmo();          //gain 99999 ammo
        }

/*  $Id: Cylinder.java 626 2011-04-22 21:49:02Z jenetic.bytemare $
 *  =======================================================================================
 */
        ...
        **************************************************************************************/
        ...
        public final void moveToTargetPosition( float newHeight, boolean disableWallCollisions, boolean disableBotCollisions )
        {
            ...
            for ( float j = iCollisionCheckingSteps; j > 0; --j )
            {
                ...
                if
                (
                        ( disableWallCollisions || !GameLevel.current().checkCollisionOnWalls( this ) )
                    &&  ( disableBotCollisions  || !GameLevel.current().checkCollisionOnBots(  this ) )
                )
                {
        ...
        public final boolean checkCollision( FaceTriangle face, boolean actionRadius )
        {
            ...
            boolean         horizontalIntersection1 = face.iCollisionLineHorz1.ptSegDist( playerPosHorz ) <= ( actionRadius ? getActionRadius() : getRadius() );
            boolean         horizontalIntersection2 = face.iCollisionLineHorz2.ptSegDist( playerPosHorz ) <= ( actionRadius ? getActionRadius() : getRadius() );

            if ( horizontalIntersection1 || horizontalIntersection2 )
            {

/*  $Id: Shooter.java 642 2011-04-24 01:38:53Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    *   TODO ASAP       highest floor is: allow z-change ( and/or allow collision ) only for specified meshes
    ...
    *   TODO LOW        merge {@link HitPoint} constructor
    *   TODO LOW        make subclasses for each wearpon ( extend the strategy pattern )
    *   TODO LOW        animate items ? ( turning etc. )
    *   TODO LOW        anti aliasing for all faces ? (via blending:/)
    *   TODO LOW        drawBulletHole and viewOnly to enums
    *   TODO LOW        make main menu
    *   TODO WEAK       composition for wearpon and gadget ! - and texture- and 3dsfiles-groups !
    *
    *   DONE            preloader / loading gauge for startup ( immediate form showup )
    *   DONE            make bullet holes different ( turn from 0 to 360 ° by random )
    *
    *   @version    0.3.3

/*  $Id: ShooterSettings.java 635 2011-04-23 23:59:23Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    ***********************************************************************************/
    public class ShooterSettings
    {
        ...
        ************************************************************************************/
        ...
        public  static  final   int                 DOOR_DESTROYED_ANIMATION_TICKS      = 100;
        ...
        **************************************************************************************/
        public enum Path
        {
            ...
            ETexturesCloth(     "/res/textures/cloth/"      ),
            EAvatars(           "/res/hud/avatars/"         ),
            EWearpons(          "/res/hud/guns/"            ),
            EShells(            "/res/hud/shells/"          ),

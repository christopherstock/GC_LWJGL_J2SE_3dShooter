/*  $Id: HitPoint.java 626 2011-04-22 21:49:02Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class HitPoint
    {
        ...
        protected final void drawWallSliver()
        {
            ...
            FX.launchSliver( vertex, sliverColors, horzSliverAngle, ( (FireArm)GameLevel.currentPlayer().getCurrentWearpon().iWearponBehaviour ).getSliverParticleQuantity() );
        }
    }

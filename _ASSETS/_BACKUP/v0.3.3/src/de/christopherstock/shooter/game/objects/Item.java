        ...
        public static enum ItemEvent
        {
            ...
            public void perform()
            {
                switch ( this )
                {
                    ...
                    {
                        GameLevel.currentPlayer().getAmmo().addAmmo( AmmoType.EBullet9mm, 20 );
                        break;
                    }

                    case EGainAmmo20ShotgunShells:
                    {
                        GameLevel.currentPlayer().getAmmo().addAmmo( AmmoType.EShotgunShells, 20 );
                        break;
                    }

                    case EGainWearponPistol9mm:
                    {
                        GameLevel.currentPlayer().deliverWearpon( Wearpon.EPistol );
                        break;
                    }

                    case EGainWearponShotgun:
                    {
                        GameLevel.currentPlayer().deliverWearpon( Wearpon.ESpaz12 );
                        break;
                    }

                    case EGainGadgetBottle1:
                    {
                        GameLevel.currentPlayer().deliverGadget( Gadget.EBottleVolvic );
                        break;
                    }

                    case EGainGadgetHandset1:
                    {
                        GameLevel.currentPlayer().deliverGadget( Gadget.EMobilePhoneSEW890i );
                        break;
                    }
                }
            }
...
*/
        ...
        public final void checkCollision()
        {
            ...
            */
            ...
            Area player = new Area( GameLevel.currentPlayer().getCylinder().getCircle() );

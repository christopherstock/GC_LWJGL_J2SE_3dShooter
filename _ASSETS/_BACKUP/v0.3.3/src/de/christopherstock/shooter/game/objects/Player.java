/*  $Id: Player.java 626 2011-04-22 21:49:02Z jenetic.bytemare $
 *  =======================================================================================
 */
...
*/
        ...
        public final void performFloorChange()
        {
            ...
            Float highestZ = GameLevel.current().getHighestFloor( iCylinder.getCenterHorz() );
...
//                    wearpon.drawAmmo( g );
        ...
        ***********************************************************************************/
        ...
        public final void launchAction()
        {
            ...
            GameLevel.current().launchAction( iCylinder );
        }
        ...
        ***********************************************************************************/
        ...
        public Wearpon getCurrentWearpon()
        {
            return iWearpon;
        }
    }

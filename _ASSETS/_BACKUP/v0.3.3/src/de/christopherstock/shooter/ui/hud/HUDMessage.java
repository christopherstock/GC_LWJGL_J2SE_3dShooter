/*  $Id: HUDMessage.java 626 2011-04-22 21:49:02Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public final class HUDMessage
    {
        ...
        public static final void drawAllMessages()
        {
            ...
            {
                int drawY = OffsetsOrtho.EBorderHudY + ( GameLevel.currentPlayer().showAmmoInHUD() ? 2 * messageQueue.elementAt( 0 ).iTextImg.height : 0 );

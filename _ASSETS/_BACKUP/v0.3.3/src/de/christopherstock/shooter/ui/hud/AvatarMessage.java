/*  $Id: AvatarMessage.java 626 2011-04-22 21:49:02Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public final class AvatarMessage
    {
        public static enum AvatarImage
        {
            ...
            {
                img = LibImage.load( ShooterSettings.Path.EAvatars.iUrl + this.toString() + LibExtension.png.getSpecifier(), ShooterDebug.glimage, true );
            }
        };
        ...
        private AvatarMessage( AvatarImage aImage, String aText, Font aFont, Color bgColor )
        {
            ...
            //calculate text
            String[] textLinesS = LibStrings.breakLinesOptimized( LibGL3D.panel.getGraphics(), aText, iFont, LibGL3D.panel.width - 3 * OffsetsOrtho.EAvatarMsgX - iImgAvatar.width - OffsetsOrtho.EBorderHudX );
        ...
        public static final void showMessage( AvatarImage img, String msg, Color bgColor )
        {
            //add a message to the queue
            messageQueue.add( new AvatarMessage( img, msg, Fonts.EAvatarMessage, bgColor ) );
        }
        ...
        {
            GameLevel.current().iBots.elementAt( 0 ).makeDistancedSound( Sound.EFemaleGiggle1 );
            ...
            //switch ( LibMath.getRandom( 0, 2 ) )
            {
                ...
                case 1:
                {
                    AvatarMessage.showMessage( AvatarImage.EWoman2, ShooterStrings.AvatarMessages.TUTORIAL_LOOK_AND_MOVE, ShooterSettings.Colors.EAvatarMessagePanelBgBlue.colABGR );
                    break;
                }

                case 2:
                {
                    AvatarMessage.showMessage( AvatarImage.EMan, ShooterStrings.AvatarMessages.TUTORIAL_PERFORM_ACTIONS, ShooterSettings.Colors.EAvatarMessagePanelBgGreen.colABGR );
                    break;
                }

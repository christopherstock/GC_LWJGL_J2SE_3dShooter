/*  $Id: Sound.java 633 2011-04-23 23:33:09Z jenetic.bytemare $
 *  =======================================================================================
 */
...
*/
            for ( int i = allSounds.size() - 1; i >= 0; --i )
            {
                ...
                {
                    float distanceToPlayer = (float)GameLevel.currentPlayer().getCylinder().getCenterHorz().distance( allSounds.elementAt( i ).getDistantLocation() );
        ...
        **************************************************************************************/
        public final void playDistancedFx( Point2D.Float distantLocation )
        {
            ...
            float distanceToPlayer = (float)GameLevel.currentPlayer().getCylinder().getCenterHorz().distance( distantLocation );
            float volume = ( distanceToPlayer <= Sounds.SPEECH_PLAYER_DISTANCE_MAX_VOLUME ? LibSound.VOLUME_MAX : ( 1.0f - ( distanceToPlayer / Sounds.SPEECH_PLAYER_DISTANCE_MUTE ) ) );

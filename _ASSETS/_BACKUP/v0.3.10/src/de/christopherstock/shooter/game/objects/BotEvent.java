/*  $Id: BotEvent.java 1134 2012-03-12 19:51:02Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    public enum BotEvent implements GameEvent
    {
        ...
        public void perform( Bot bot )
        {
            switch ( this )
            {
                ...
                {
                    ShooterGameLevel.orderLevelChange( LevelConfig.values()[ ShooterGameLevel.current().iConfig.ordinal() + 1 ], false );

/*  $Id: Player.java 1134 2012-03-12 19:51:02Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    import  de.christopherstock.shooter.game.wearpon.ArtefactType.GiveTakeAnim;
    ...
    *   @version    0.3.10
    **************************************************************************************/
    public class Player implements LibGameObject, PlayerAttributes, ShotSpender
    {
        ...
        **************************************************************************************/
        ...
        public Player( ViewSet aStartPosition, boolean aDisableGravity )
        {
            ...
            iCylinder               = new Cylinder( this, new LibVertex( aStartPosition.pos.x, aStartPosition.pos.y, aStartPosition.pos.z ), RADIUS_BODY, DEPTH_TOTAL_STANDING, ShooterSettings.Performance.COLLISION_CHECKING_STEPS, ShooterDebug.playerCylinder, false, PlayerAttributes.MAX_CLIMBING_UP_Z, PlayerAttributes.MIN_CLIMBING_UP_Z );
...
*/
        ...
        private void handleKeysForActions()
        {
            ...
            if ( MouseInput.mouseHoldZoom || Keys.keyHoldZoom )
            {
                ...
                iScaleFactor = ShooterGameLevel.currentPlayer().iZoom / General.MAX_ZOOM;
            }
            else
            {
                iAiming = false;
        ...
        private final void performFloorChange()
        {
            ...
            if ( ShooterGameLevel.current().hasInvisibleZLayer() )
            {
...
*/
        ...
        {
            boolean isFirearm = ( iArtefactSet.getArtefactType().iWearponBehaviour instanceof FireArm );
            return
            (
                    isFirearm
                ?   new LibShot
                    (
                        ...
                        ( (FireArm)( iArtefactSet.getArtefactType().iWearponBehaviour ) ).getCurrentIrregularityHorz(),
                        ( (FireArm)( iArtefactSet.getArtefactType().iWearponBehaviour ) ).getCurrentIrregularityVert(),
                        ...
                        iArtefactSet.getArtefactType().iWearponBehaviour.getBulletHoleSize(),
                        ShooterDebug.shotAndHit,
                        iArtefactSet.getArtefactType().iWearponBehaviour.getSliverParticleQuantity(),
                        FxSettings.SLIVER_ANGLE_MOD,
                        iArtefactSet.getArtefactType().getDamage(),
                        iArtefactSet.getArtefactType().iWearponBehaviour.getSliverParticleSize(),
                        iArtefactSet.getArtefactType().getIsWallBreakable(),
                        iArtefactSet.getArtefactType().getProjectile()
                    )
                :   new LibShot
                    (
                        ShotType.ESharpAmmo,
...
*/
        public final void orderWearponOrGadget( HUD.ChangeAction changeAction )
        {
            ...
            (
                ...
                &&
                    (
                            !( iArtefactSet.iCurrentArtefact.iArtefactType.iWearponBehaviour instanceof Gadget )
                        ||  ( (Gadget)iArtefactSet.iCurrentArtefact.iArtefactType.iWearponBehaviour ).iGiveTakeAnimState == GiveTakeAnim.ENone
                    )
            )
            {
        ...
        ***********************************************************************************/
        ...
        {
            boolean invincible = PlayerAttributes.INVINCIBILITY;
        ...
        public final void launchAction( Gadget gadget )
        {
            ...
            {
                ShooterGameLevel.current().startAdrenaline();
            }
            else
            {
                ...
                if ( gadget == null )
                {
                    actionCylinder.setRadius( PlayerAttributes.RADIUS_ACTION );
                }
                else
                {
                ...
                ShooterGameLevel.current().launchAction( actionCylinder, gadget, iView.iRot.z );
            }
        }
        ...
        public final ViewSet getCameraPositionAndRotation()
        {
            ...
            if ( iDead )
            {
                ...
                posZ = -iCylinder.getAnchor().z - PlayerAttributes.DEPTH_DEATH - ( iView.iDepthEye - iView.iDieModTransZ );

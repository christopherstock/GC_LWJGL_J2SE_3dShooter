/*  $Id: PlayerView.java 1134 2012-03-12 19:51:02Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    import  de.christopherstock.shooter.base.ShooterGameLevel;
        ...
        protected final void handleKeysForView()
        {
            ...
            else
            {
                ...
                )
                {
                    ...
                    if ( !disableWallCollisions && ShooterGameLevel.current().checkCollisionOnWalls( iParentPlayer.getCylinder() ) )
                    {
                        iDepthEye  -= SPEED_CROUCH_TOGGLE;
                        iDepthHand -= SPEED_CROUCH_TOGGLE;
                        iDepthTotal = DEPTH_TOTAL_CROUCHING;

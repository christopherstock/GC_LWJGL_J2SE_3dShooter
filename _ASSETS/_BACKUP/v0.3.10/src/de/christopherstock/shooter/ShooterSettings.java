/*  $Id: ShooterSettings.java 1134 2012-03-12 19:51:02Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    import  de.christopherstock.shooter.base.ShooterMainThread.*;
    ...
    public class ShooterSettings
    {
        ...
        public static final class General
        {
            ...
            ************************************************************************************/
            ...
            public      static  final   LevelConfig STARTUP_LEVEL                       = LevelConfig.ELevel1Offices1;
        ...
        {
            public  static  final   Font            EIntro                              = new Font( "verdana",     Font.BOLD,  25 );
            public  static  final   Font            EMainMenu                           = new Font( "verdana",     Font.BOLD,  40 );
        ...
        **************************************************************************************/
        public static interface PlayerAttributes
        {
            ...
            public  static  final   float           RADIUS_ACTION                       = 2.5f;                 //player's action   radius
            ...
            public  static  final   float           MAX_ACTION_VIEW_ANGLE               = 80.0f;                //to left and right side of the center view

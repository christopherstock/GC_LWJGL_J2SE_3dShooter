/*  $Id: BotMeshes.java 1134 2012-03-12 19:51:02Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class BotMeshes extends MeshCollection
    {
      ...
      //public      static  final   Offset              OFFSET_ABSOLUTE_RIGHT_HAND          = new Offset(   0.15f,      -0.025f,    0.8f    );
        ...
        **************************************************************************************/
        public BotMeshes( ShooterBotPattern aTemp, LibVertex aAnchor, LibGameObject aParentGameObject, Items itemLeft, Items itemRight )
        {
            //assign template
            iTemplate = aTemp;

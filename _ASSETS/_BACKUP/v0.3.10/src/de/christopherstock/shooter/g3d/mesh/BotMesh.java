/*  $Id: BotMesh.java 1134 2012-03-12 19:51:02Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class BotMesh extends Mesh
    {
        ...
        **************************************************************************************/
        public BotMesh( FaceTriangle[] aFaces, LibVertex aAnchor, float aInitRotZ, float aInitScale, LibGameObject aParentGameObject, float aDamageMultiplier )
        {
            super( aFaces, aAnchor, aInitRotZ, aInitScale, Invert.ENo, aParentGameObject, LibTransformationMode.EOriginalsToTransformed, DrawMethod.EHideIfTooDistant );
            for ( FaceTriangle ft : aFaces )
            {

/*  $Id: FaceEllipseWall.java 1134 2012-03-12 19:51:02Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class FaceEllipseWall extends Face
    {
        ...
        public FaceEllipseWall( LibGLTexture aTextureID, float aHorzFaceAngle, float aVertFaceAngle, float aX, float aY, float aZ, float aRadiusX, float aRadiusZ )
        {
            this( aTextureID, aHorzFaceAngle, aVertFaceAngle, aX, aY, aZ, aRadiusX, aRadiusZ, LibMath.getRandom( 0, 360 ) );
        }

/*  $Id: HUDMessageManager.java 1134 2012-03-12 19:51:02Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public final class HUDMessageManager
    {
        ...
        public final void drawAll()
        {
            ...
            {
                int drawY = OffsetsOrtho.EBorderHudY + ( ShooterGameLevel.currentPlayer().iArtefactSet.showAmmoInHUD() ? 2 * messageQueue.elementAt( 0 ).getTexImgHeight() : 0 );

/*  $Id: LWJGLMouse.java 1104 2012-03-11 16:53:51Z jenetic.bytemare $
 *  =======================================================================================
 */
...
import  de.christopherstock.shooter.io.hid.*;
    ...
    {
        public static final void checkMouse( boolean centerMouse )
        {
        ...
        public static final void centerMouse()
        {
            if ( Display.isActive() )
            {
                //ShooterDebug.bugfix.out( "Display is active - center mouse" );

                //center mouse
                Mouse.setCursorPosition( LibGL3D.panel.width / 2, LibGL3D.panel.height / 2 );

                //ignore all current events
                while ( Mouse.next() ) {}
            }
        }

        public static final void hideCursor()
        {
            try
            {
                //inoperative on mac :(

                BufferedImage bi  = ImageIO.read( Lib.preStreamJarResource( ShooterSettings.Path.EScreen.iUrl + "invisible.png" ) );

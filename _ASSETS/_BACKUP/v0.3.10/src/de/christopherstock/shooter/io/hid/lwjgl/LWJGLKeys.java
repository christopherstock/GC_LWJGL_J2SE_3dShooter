/*  $Id: LWJGLKeys.java 1104 2012-03-11 16:53:51Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    public class LWJGLKeys extends Keys
    {
        public static final void checkKeys()
        {
            ...
            avatarMessage.iKeyHold              = displayHasFocus && (   Keyboard.isKeyDown( Keyboard.KEY_RETURN     ) );
            ...
            {
                ShooterGameLevel.current().clearBulletHoles();
            }
/*
...
*/
            ...
            try
            {
                if ( Keyboard.isKeyDown( Keyboard.KEY_1 ) ) ShooterGameLevel.orderLevelChange( LevelConfig.values()[ 0 ], true );
                if ( Keyboard.isKeyDown( Keyboard.KEY_2 ) ) ShooterGameLevel.orderLevelChange( LevelConfig.values()[ 1 ], true );
                if ( Keyboard.isKeyDown( Keyboard.KEY_3 ) ) ShooterGameLevel.orderLevelChange( LevelConfig.values()[ 2 ], true );
                if ( Keyboard.isKeyDown( Keyboard.KEY_4 ) ) ShooterGameLevel.orderLevelChange( LevelConfig.values()[ 3 ], true );
                if ( Keyboard.isKeyDown( Keyboard.KEY_5 ) ) ShooterGameLevel.orderLevelChange( LevelConfig.values()[ 4 ], true );
            }

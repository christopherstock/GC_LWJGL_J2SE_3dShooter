/*  $Id: LibJOGLView.java 1134 2012-03-12 19:51:02Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class LibJOGLView extends LibGLView implements GLEventListener
    {
        ...
        public LibJOGLView( GLDrawCallback aDrawCallback, LibDebug aDebug )
        {
            super( aDebug );
...
*/
        ...
        public void setNewGluFaceAngle( float faceAngle )
        {
            gl.glMatrixMode( GL.GL_PROJECTION );
            gl.glLoadIdentity();
            float ratio = ( (float)ShooterSettings.Form.FORM_WIDTH / (float)ShooterSettings.Form.FORM_HEIGHT );
            glu.gluPerspective( faceAngle, ratio, LibGLView.VIEW_MIN, LibGLView.VIEW_MAX );
        }
    }

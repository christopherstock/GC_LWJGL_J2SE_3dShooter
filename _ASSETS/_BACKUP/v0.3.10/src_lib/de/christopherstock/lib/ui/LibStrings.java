/*  $Id: LibStrings.java 1134 2012-03-12 19:51:02Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class LibStrings
    {
        ...
        *********************************************************************************************/
        ...
        public static final void drawString( Graphics2D g, Color colFg, Color colShadow, Color colOutline, Font fnt, LibAnchor anchor, String str, int aX, int aY )
        {
            int x            = aX;
            int y            = aY;
        ...
        private static final int getNearestLinebreakIndex( String aString, int aStartIndex )
        {
        ...
        public static final void drawStrings( Graphics2D g, String[] lines, Font iFont, int aX, int aY, Color fg, Color shadow, Color outline, float lineSpacingRatioEmptyLines )
        {
            int drawX       = aX;
            int drawY       = aY;
            int iLineHeight = LibStrings.getStringHeight( g, iFont );

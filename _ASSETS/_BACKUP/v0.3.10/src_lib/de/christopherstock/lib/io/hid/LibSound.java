/*  $Id: LibSound.java 1134 2012-03-12 19:51:02Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    public class LibSound extends Thread implements LineListener
    {
        ...
        public void run()
        {
            try
            {
                ...
                {
                    ShooterDebug.error.out( "Caught OutOfMemoryError on initing sound clip" );
                    return;
                }
...
*/
        ...
        public void updateDistancedSound( float volume )
        {
            ...
            //clip volume
            if ( newVolume < LibSound.VOLUME_MUTE ) newVolume = LibSound.VOLUME_MUTE;
            if ( newVolume > LibSound.VOLUME_MAX  ) newVolume = LibSound.VOLUME_MAX;

/*  $Id: HUDMessage.java 794 2011-05-27 22:46:10Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public final class HUDMessage
    {
        ...
        public static final void drawAllMessages()
        {
            ...
            {
                int drawY = OffsetsOrtho.EBorderHudY + ( ShooterGameLevel.currentPlayer().showAmmoInHUD() ? 2 * messageQueue.elementAt( 0 ).iTextImg.height : 0 );

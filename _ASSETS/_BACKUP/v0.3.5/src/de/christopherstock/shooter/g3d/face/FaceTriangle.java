/*  $Id: FaceTriangle.java 794 2011-05-27 22:46:10Z jenetic.bytemare $
 *  =======================================================================================
 */
        ...
        public HitPoint launchShotNew( Shot shot )
        {
            ...
            switch ( iDrawMethod )
            {
                ...
                case EHideIfTooDistant:
                {
                    ...
                    LibGLMaterial faceMaterial  = ( faceTexture == null ? WallTex.EConcrete1.getTexture().getMaterial() : faceTexture.getMaterial() );

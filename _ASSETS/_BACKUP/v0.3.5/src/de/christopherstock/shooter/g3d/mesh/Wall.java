/*  $Id: Wall.java 794 2011-05-27 22:46:10Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class Wall extends Mesh implements GameObject
    {
        ...
        {
            super(              ShooterD3dsFiles.getFaces( aD3dsFile ), aAnchor, ( aWallAction == WallAction.ESprite ? 0.0f : aStartupRotZ ), aScalation.getScaleFactor(), null, LibTransformationMode.EOriginalsToOriginals, aDrawMethod );
            ...
            if ( iWallAction == WallAction.ESprite )
            {
        ...
        {
            //if ( !iDestroyed ) //also animate if being destroyed
            {
                ...
                switch ( iWallAction )
                {
                    case ESprite:
                    {
                        ...
                        float angleSpriteToPlayer = LibMath.normalizeAngle( anglePlayerToSprite + 90.0f );
                        ...
                        FX.launchStaticPoint( ank, LibColors.EBlue, 1, 0.05f );
                ...
                if ( iWallAction != WallAction.ENone )
                {
                    ...
                    if ( checkAction( cylinder ) )
                    {
                        switch ( iWallAction )
                        {
                            ...
                            case ESprite:
                            {
                                ShooterDebug.major.out( "launch action on sprite" );
                                break;
                            }

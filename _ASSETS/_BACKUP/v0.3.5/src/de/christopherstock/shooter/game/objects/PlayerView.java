/*  $Id: PlayerView.java 794 2011-05-27 22:46:10Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class PlayerView implements PlayerAttributes
    {
        ...
        **************************************************************************************/
        ...
        public                      float           iHandTransX                 = TRANS_X_HAND;
        public                      float           iHandTransY                 = TRANS_Y_HAND;
        ...
        public final void animateDying()
        {
            ...
            if ( iParentPlayer.isDead() )
            {
                ...
                if ( ( dyingAnimation++ ) % 4 == 0 ) HUDFx.launchDamageFX( 15 );
            }
        }
    }

/*  $Id: Bot.java 794 2011-05-27 22:46:10Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class Bot implements GameObject
    {
        ...
        private                     Bots                iItemLeft               = null;
        private                     Bots                iItemRight              = null;
        private                     LibVertex           iStartPosition          = null;

        public Bot( ShooterBotPattern aTemplate, BotType aType, LibVertex aStartPosition, Point2D.Float[] aWayPoints, BotJob aJob, Bots aItemLeft, Bots aItemRight )
        {
            iType           = aType;
            iCylinder       = new Cylinder( this, aStartPosition, aTemplate.iBase.iRadius, aTemplate.iBase.iHeight, 0, ShooterDebug.bot, DebugSettings.DEBUG_DRAW_BOT_CIRCLES, 0.0f, 0.0f );
            iWayPoints      = aWayPoints;
            iJob            = aJob;
            iHealth         = 100;  //set full health
            iItemLeft       = aItemLeft;
            iItemRight      = aItemRight;
            iTemplate       = aTemplate;
            iStartPosition  = aStartPosition;

            //init mesh-collection
            iBotMeshes      = new BotMeshes( iTemplate, iStartPosition, this, iItemLeft, iItemRight );
        ...
        {
            return ( iDying ? false : iCylinder.checkCollisionHorz( aCylinder ) );
        }
...
*/
        ...
        public final boolean botSeesThePlayer( float viewAngle )
        {
            ...
            return ( hitPoint != null && hitPoint.iCarrier.getHitPointCarrier() == GameObject.HitPointCarrier.EPlayer );
        }

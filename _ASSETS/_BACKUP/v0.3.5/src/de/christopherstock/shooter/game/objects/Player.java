/*  $Id: Player.java 794 2011-05-27 22:46:10Z jenetic.bytemare $
 *  =======================================================================================
 */
...
*/
        ...
        public final Shot getShot()
        {
            ...
            (
                ...
                iCylinder.getAnchor().x    + ( LibMath.sinDeg( iView.rot.z + 90.0f ) * iView.iHandTransX ) - ( LibMath.sinDeg( iView.rot.z ) * iView.iHandTransY ),
                iCylinder.getAnchor().y    + ( LibMath.cosDeg( iView.rot.z + 90.0f ) * iView.iHandTransX ) - ( LibMath.cosDeg( iView.rot.z ) * iView.iHandTransY ),

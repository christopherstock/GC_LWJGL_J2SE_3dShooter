/*  $Id: LibStrings.java 794 2011-05-27 22:46:10Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class LibStrings
    {
        ...
        *********************************************************************************************/
        public static final void drawString( Graphics2D g, Color col, Font fnt, LibAnchor anchor, String str, int x, int y )
        {
            drawString( g, col, null, null, fnt, anchor, str, x, y );
        }

        public static final void drawString( Graphics2D g, Color colFg, Color colShadow, Color colOutline, Font fnt, LibAnchor anchor, String str, int x, int y )
        {
        ...
        public static final void debugLineBreaks( Graphics2D g2d, LibDebug debug, Font font )
        {
        ...
        public static final int getLinesHeight( Graphics2D g, String[] lines, Font iFont, float lineSpacingRatioEmptyLines )
        {
            int iBlockHeight = 0;
        ...
        public static final void drawStrings( Graphics2D g, String[] lines, Font iFont, int x, int y, Color fg, Color shadow, Color outline, float lineSpacingRatioEmptyLines )
        {
            int iLineHeight = LibStrings.getStringHeight( g, iFont );
            ...
            for ( String line : lines )
            {
                ...
                if ( line == null || line.isEmpty() )
                {
                    y += ( iLineHeight * lineSpacingRatioEmptyLines );
                }
                else
                {
                    LibStrings.drawString( g, fg, shadow, outline, iFont, LibAnchor.EAnchorLeftTop, line, x, y );
                    y += iLineHeight;
                }
            }
        }

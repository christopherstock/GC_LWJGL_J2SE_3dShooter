/*  $Id: Wearpon.java 685 2011-05-01 02:04:30Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public enum Artefact
    {
        ...
        EKnife(             new CloseCombat(),                                                                                                                                      2.0f,       800,                false,              1 ),
        EWaltherPPK(        new FireArm( AmmoType.EBullet44mm,          7,          3,          3,          1,              0,      Sound.EBulletShot1,     Sound.EReload1    ),    10.0f,      250,                true,               1 ),
        ...
        EHuntingRifle(      new FireArm( AmmoType.EBullet51mm,          50,         35,         35,         1,              0,      Sound.EShot1,           Sound.EReload2    ),    45.0f,      100,                true,               3 ),
        ...
        ERCP180(            new FireArm( AmmoType.EBullet792mm,         180,        10,         10,         1,              0,      Sound.EShot1,           Sound.EReload2    ),    50.0f,      50,                 false,              1 ),
        ESniperRifle(       new FireArm( AmmoType.EBullet792mm,         8,          0,          0,          1,              0,      Sound.EBulletShot1,     Sound.EReload2    ),    100.0f,     150,                false,              1 ),

        EEnvelope(          new Gadget(),                                                                                                                                      2.0f,       1000,               false,              1 ),
        EMacAir(            new Gadget(),                                                                                                                                      2.0f,       1000,               false,              1 ),
        EAirMailLetter(     new Gadget(),                                                                                                                                      2.0f,       1000,               false,              1 ),
        EBottleVolvic(      new Gadget(),                                                                                                                                      2.0f,       1000,               false,              1 ),
        EMobilePhoneSEW890i(new Gadget(),                                                                                                                                      2.0f,       1000,               false,              1 ),
        EChips(             new Gadget(),                                                                                                                                      2.0f,       1000,               false,              1 ),
        ...
        **************************************************************************************/
        ...
        private Artefact( WearponKind aWearponKind, float aRange, int aDelayAfterUse, boolean aUseNeedsKeyRelease, int aShotsTillKeyReleaseRequired )
        {

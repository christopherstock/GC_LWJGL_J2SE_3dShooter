/*  $Id: Bot.java 706 2011-05-04 21:40:34Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class Bot implements GameObject
    {
        ...
        {
            iType           = aType;
            iCylinder       = new Cylinder( this, aStartPosition, aTemplate.iRadius, aTemplate.iHeight, 0, ShooterDebug.bot, DebugSettings.DEBUG_DRAW_BOT_CIRCLES, 0.0f, 0.0f );

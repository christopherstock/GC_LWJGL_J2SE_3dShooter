/*  $Id: AvatarMessage.java 706 2011-05-04 21:40:34Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public final class AvatarMessage
    {
        public static enum AvatarImage
        {
            ...
            {
                img = LibImage.load( ShooterSettings.Path.EAvatar.iUrl + this.toString() + LibExtension.png.getSpecifier(), ShooterDebug.glimage, true );
            }
        };

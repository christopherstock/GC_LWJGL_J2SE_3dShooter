/*  $Id: LWJGLKeys.java 694 2011-05-02 17:44:49Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    public class LWJGLKeys extends Keys
    {
        public static final void checkKeys()
        {
            ...
            {
                ShooterGameLevel.orderLevelChange( LevelConfig.ELevel1 );
            }

            if ( Keyboard.isKeyDown( Keyboard.KEY_2 ) )
            {
                ShooterGameLevel.orderLevelChange( LevelConfig.ELevel2 );
            }
/*

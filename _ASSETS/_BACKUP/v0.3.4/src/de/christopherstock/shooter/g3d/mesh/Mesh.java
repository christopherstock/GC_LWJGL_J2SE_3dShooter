/*  $Id: Mesh.java 706 2011-05-04 21:40:34Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    public class Mesh implements LibGeomObject
    {
        ...
        **************************************************************************************/
        ...
        public final Point2D.Float getCenterPointXY()
        {
            ...
            return new Point2D.Float( lowestX.floatValue() + ( highestX.floatValue() - lowestX.floatValue() ) / 2, lowestY.floatValue() + ( highestY.floatValue() - lowestY.floatValue() ) / 2 );
        }

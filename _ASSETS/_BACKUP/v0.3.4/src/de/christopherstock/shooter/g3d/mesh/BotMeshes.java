/*  $Id: BotMeshes.java 706 2011-05-04 21:40:34Z jenetic.bytemare $
 *  =======================================================================================
 */
        ...
        **************************************************************************************/
        public BotMeshes( ShooterBotTemplate aTemplate, LibVertex aAnchor, GameObject aParentGameObject, Bots itemLeft, Bots itemRight )
        {
            ...
            else
            {
                ...
                iHat.changeTexture(             Default.ETest.getTexture(),          aTemplate.iTexHat.getTexture()                  );
            }
            ...
            else
            {
                ...
                iGlasses.changeTexture(             Default.ETest.getTexture(),         aTemplate.iTexGlassesGlass.getTexture()         );
                iGlasses.changeTexture(             BotTex.EHairBlonde.getTexture(),    aTemplate.iTexGlassesHolder.getTexture()        );
            }
            ...
            iRightUpperLeg.changeTexture(   Default.ETest.getTexture(),          aTemplate.iTexRightUpperLeg.getTexture()        );
            iLeftUpperLeg.changeTexture(    Default.ETest.getTexture(),          aTemplate.iTexLeftUpperLeg.getTexture()         );
            iRightLowerLeg.changeTexture(   Default.ETest.getTexture(),          aTemplate.iTexRightLowerLeg.getTexture()        );
            iLeftLowerLeg.changeTexture(    Default.ETest.getTexture(),          aTemplate.iTexLeftLowerLeg.getTexture()         );

            iLeftFoot.changeTexture(        Default.ETest.getTexture(),          aTemplate.iTexLeftFoot.getTexture()             );
            iRightFoot.changeTexture(       Default.ETest.getTexture(),          aTemplate.iTexRightFoot.getTexture()            );
            iLeftUpperArm.changeTexture(    Default.ETest.getTexture(),          aTemplate.iTexLeftUpperArm.getTexture()         );
            iRightUpperArm.changeTexture(   Default.ETest.getTexture(),          aTemplate.iTexRightUpperArm.getTexture()        );
            iLeftLowerArm.changeTexture(    Default.ETest.getTexture(),          aTemplate.iTexLeftLowerArm.getTexture()         );
            iRightLowerArm.changeTexture(   Default.ETest.getTexture(),          aTemplate.iTexRightLowerArm.getTexture()        );
            iLeftHand.changeTexture(        Default.ETest.getTexture(),          aTemplate.iTexLeftHand.getTexture()             );
            iRightHand.changeTexture(       Default.ETest.getTexture(),          aTemplate.iTexRightHand.getTexture()            );
            iNeck.changeTexture(            Default.ETest.getTexture(),          aTemplate.iTexNeck.getTexture()                 );
            iTorso.changeTexture(           Default.ETest.getTexture(),          aTemplate.iTexTorsoUpper.getTexture()           );
            iTorso.changeTexture(           BotTex.EHairBlonde.getTexture(),     aTemplate.iTexTorsoLower.getTexture()           );
            iHead.changeTexture(            BotTex.EHairBlonde.getTexture(),     aTemplate.iTexHair.getTexture()                 );
            iFace.changeTexture(            Default.ETest.getTexture(),          aTemplate.iTexFaceEyesOpen.getTexture()         );

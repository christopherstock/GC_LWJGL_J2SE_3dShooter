/*  $Id: LibGLImage.java 645 2011-04-24 13:00:02Z jenetic.bytemare $
 *  =======================================================================================
 */
    ...
    public class LibGLImage
    {
        ...
        public LibGLImage( BufferedImage aBufferedImage, ImageUsage imageUsage, LibDebug debug, boolean flipAllBytes )
        {
            ...
            switch ( imageUsage )
            {
                case EOrtho:
                {
                    bytes   = getByteBuffer( aBufferedImage, debug, flipAllBytes );
                    break;
                }
        ...
        private static final ByteBuffer getByteBuffer( BufferedImage aBufferedImage, LibDebug debug, boolean flipAllBytes )
        {
